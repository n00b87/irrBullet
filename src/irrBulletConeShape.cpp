...
IConeShape::IConeShape(ISceneNode* const n, f32 m, bool overrideMargin, irr::f32 radius)
{
	node = n;
	mass = m;
...
void IConeShape::createShape(bool overrideMargin, irr::f32 override_radius)
{
